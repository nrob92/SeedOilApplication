        ...
        <section id="about">
          <div className="section-box">
            ...
            <p>
              ...
              oil, and coconut oil. Additionally, the app allows users to search
              for restaurants that use other types of healthy fats such as
              butter, ghee, or tallow. The app's goal is to make it easy for
              people to make informed choices about the food they eat when
              dining out.
            </p>
          </div>
        </section>
        <section id="faq">
          <div className="section-box">
            ...
            <p>
              ...
              out if they use seed oils in their cooking. Send an inquiry to the
              restaurant directly through our built-in auto-mailer feature. Keep
              track of the restaurant's response and update their information in
              our app with a screenshot of the reply. Make informed decisions
              about your meals and enjoy dining out without any guilt!
              <br /> <br />
              ...
              lead to inflammation in the body when consumed in excess. They are
              also often highly processed and refined, which can strip them of
              important nutrients and increase the likelihood of rancidity.
              <br />
              <br />
              <strong>
                {" "}
